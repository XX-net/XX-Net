...
* X-Tunnel 请升级到[3.7.0]，目前基本可用。(https://github.com/XX-net/XX-Net/releases). （[使用教程](https://github.com/XX-net/XX-Net/wiki/x-tunnel%E4%BD%BF%E7%94%A8%E6%95%99%E7%A8%8B)）  
**X-Tunnel 用户套餐流量丢失的，请给xxnet.dev@gmail.com 发邮件。**
  接下来会继续完善x-tunnel，减少卡顿。  
