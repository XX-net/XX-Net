...
if hasattr(sys.stderr, 'isatty') and sys.stderr.isatty():
    if os.name == 'nt':
        ...
        __set_error_color = lambda: SetConsoleTextAttribute(
            GetStdHandle(-11), 0x04)
        __set_warning_color = lambda: SetConsoleTextAttribute(
            GetStdHandle(-11), 0x06)
        __set_debug_color = lambda: SetConsoleTextAttribute(
            GetStdHandle(-11), 0x002)
        __reset_color = lambda: SetConsoleTextAttribute(
