...
class MacTrayObject(NSObject):
    ...
    def getProxyState(self):
        ...
        checkAutoProxyUrlEthernetCommand, checkAutoProxyUrlThunderboltCommand, checkAutoProxyUrlWiFiCommand)
        ...
        executeCommand = "%s;%s;%s;" % (
        checkGlobalProxyUrlEthernetCommand, checkGlobalProxyUrlThunderboltCommand, checkGlobalProxyUrlWiFiCommand)
        executeResult = subprocess.check_output(executeCommand, shell=True)
    ...
    def setupUI(self):
        ...
        menuitem = NSMenuItem.alloc().initWithTitle_action_keyEquivalent_('Enable Global GAEProxy',
                                                                          'enableGlobalProxy:', '')
        if proxyState == 'gae':
            menuitem.setState_(NSOnState)
        self.menu.addItem_(menuitem)
    ...
    def enableAutoProxy_(self, _):
        ...
        disableProxyCommand, enableAutoProxyCommand)
    ...
    def getEnableAutoProxyCommand(self):
        ...
        executeCommand = "%s;%s;%s" % (
        enableAutoProxyEthernetCommand, enableAutoProxyThunderboltCommand, enableAutoProxyWiFiCommand)
    ...
    def enableGlobalProxy_(self, _):
        ...
        rootCommand = """osascript -e 'do shell script "%s;%s" with administrator privileges' """ % (
        disableProxyCommand, enableGlobalProxyCommand)
        executeCommand = rootCommand.encode('utf-8')
    ...
    def getEnableGlobalProxyCommand(self):
        ...
        executeCommand = "%s;%s;%s;%s;%s;%s" % (
        enableHttpProxyEthernetCommand, enableHttpProxyThunderboltCommand, enableHttpProxyWiFiCommand,
    ...
    def getDisableProxyCommand(self):
        ...
        executeCommand = "%s;%s;%s;%s;%s;%s;%s;%s;%s" % (
        disableHttpProxyEthernetCommand, disableHttpProxyThunderboltCommand, disableHttpProxyWiFiCommand,
