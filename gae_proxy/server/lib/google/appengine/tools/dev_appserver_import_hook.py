    ...
    def SetAllowedModule(name):
        ...
        if stream:
            ...
            if pathname.startswith(SITE_PACKAGES):
                ...
                FakeFile.ALLOWED_SITE_PACKAGE_DIRS.add(
...
class HardenedModulesHook(object):
    ...
    def __init__(self,
        ...
        self._white_list_partial_modules = dict(
            self._WHITE_LIST_PARTIAL_MODULES)
        ...
        if self._config and self._config.runtime == 'python27':
            ...
            if self._config.libraries:
                for libentry in self._config.libraries:
                    ...
                    extra = self.__PY27_OPTIONAL_ALLOWED_MODULES.get(
                        libentry.name)
    ...
    def FindModuleRestricted(self,
        ...
        for path_entry in search_path:
            result = self.FindPathHook(
                submodule, submodule_fullname, path_entry)
    ...
    def FindAndLoadModule(self,
        ...
        if submodule_fullname == 'thread':
            ...
            source_file, pathname, description = self.FindModuleRestricted(
                submodule, submodule_fullname, search_path)
        ...
        if submodule_fullname == 'os':
            ...
            os_path = self.FindAndLoadModule(
                os_path_name, os_path_name, search_path)
