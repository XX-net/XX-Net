...
def upload(appid):
    ...
    with open(app_yaml_file, 'wb') as fp:
        filedatas = re.sub(r'application:\s*\S+', 'application: '+appid, yaml.decode())
        fp.write(filedatas.encode())
    ...
    for file_name in file_names:
        ...
        try:
            ...
            with open(filename, 'wb') as fp:
                filedatas = re.sub(r"__password__ = '.*?'", "__password__ = '%s'" % rc4_password, file_data.decode())
                fp.write(filedatas.encode())
